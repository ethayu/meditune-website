        ...
        <div className="pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
            ...
            <div className="md:col-span-7 lg:col-span-7 mb-8 md:mb-0 text-center md:text-left">
              <h1 className="h1 lg:text-6xl mb-4 font-red-hat-display font-extrabold" data-aos="fade-down">Meditune</h1>
              <p className="text-xl text-gray-600 dark:text-gray-400" data-aos="fade-down" data-aos-delay="150">We help people tune out their tinnitus. Meditune uses Notched Music Therapy to help users experience life without ringing.</p>
              {/* CTA form */}
              <form className="mt-8" data-aos="fade-down" data-aos-delay="300">
                <div className="flex flex-col sm:flex-row justify-center max-w-sm mx-auto sm:max-w-md md:mx-0">
                  <input type="tel" className="form-input w-full mb-2 sm:mb-0 sm:mr-2" placeholder="Email" aria-label="Phone number" />
                  <a className="btn text-white bg-teal-500 hover:bg-teal-400 flex-shrink-0" href="https://forms.gle/oPdRr8iEJruNvtzM9">Join Beta</a>
                </div>
                {/* Success message */}
              ...
              <ul className="max-w-sm sm:max-w-md mx-auto md:max-w-none text-gray-600 dark:text-gray-400 mt-8 -mb-2" data-aos="fade-down" data-aos-delay="450">
                <li className="flex items-center mb-2">
                  ...
                  <span>Sign up for our free IOS and Android beta.</span>
                </li>
                <li className="flex items-center mb-2">
                  <svg className="w-3 h-3 fill-current text-teal-400 mr-2 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                  </svg>
                  <span>Diagnose the frequency of your tinnitus.</span>
                </li>
                <li className="flex items-center mb-2">
                  <svg className="w-3 h-3 fill-current text-teal-400 mr-2 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                  </svg>
                  <span>Generate tailored music and soundscapes.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="md:col-span-5 lg:col-span-5 text-center md:text-right" data-aos="fade-up" data-aos-delay="450">
              <div className="inline-flex relative justify-center items-center">
                ...
                <img className="absolute" src={require('../images/meditune-mockup-1.png').default} width="290" height="624" style={{ maxWidth: '84.33%' }} alt="Features illustration" />
                {/* iPhone mockup */}
