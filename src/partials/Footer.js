    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
            ...
            <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
                ...
                <div className="md:col-span-2 lg:col-span-3">
                    ...
                    <Link className="inline-block" to="/" aria-label="Cruip">
                        ...
                        <img src={require('../images/logo512.png').default} width="36" height="36" alt="Features illustration" />
                    </Link>
                </div>
            ...
            <div className="md:flex md:items-center md:justify-between">
                ...
                {/* Copyrights note */}
                <div className="text-gray-600 dark:text-gray-400 text-sm mr-4">&copy; 2022 Meditune. All rights reserved.</div>
