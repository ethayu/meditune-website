      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h3 font-red-hat-display mb-4">Music therapy made simple.</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">First, we'll diagnose your frequency. Next, we apply notching algorithms to tailor your music. Finally, you'll listen to sounds that train your brain to ignore tinnitus!</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:gap-x-6 lg:gap-x-12 md:grid-cols-3 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                ...
                <img className="absolute" src={require('../images/meditune-mockup-2.png').default} width="290" height="624" style={{ maxWidth: '84.33%' }} alt="App screen 02" />
                {/* iPhone mockup */}
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                {/* Image inside mockup size: 290x624px (or 580x1248px for Retina devices) */}
                <img className="absolute" src={require('../images/meditune-mockup-1.png').default} width="290" height="624" style={{ maxWidth: '84.33%' }} alt="App screen 03" />
                {/* iPhone mockup */}
                <img className="relative max-w-full mx-auto h-auto pointer-events-none" src={require('../images/iphone-mockup.png').default} width="344" height="674" alt="iPhone mockup" aria-hidden="true" />
              </div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="inline-flex relative justify-center items-center">
                {/* Image inside mockup size: 290x624px (or 580x1248px for Retina devices) */}
                <img className="absolute" src={require('../images/meditune-mockup-3.png').default} width="290" height="624" style={{ maxWidth: '84.33%' }} alt="App screen 04" />
                {/* iPhone mockup */}
                <img className="relative max-w-full mx-auto h-auto pointer-events-none" src={require('../images/iphone-mockup.png').default} width="344" height="674" alt="iPhone mockup" aria-hidden="true" />
              </div>
            </div>
